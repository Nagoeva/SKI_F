	...
	return (<>
		...
		<div className={`${scss.wrap} container`}>
			...
			<div className={`${scss.block}`} data-block='info'>
				<h2 className={scss.title}>Северо-кавказский институт повышения квалификации (филиал) краснодарского университета МВД России <br/> Кафедра специально-технической подготовки</h2>
			</div>
			<div className={`${scss.block}`} data-block='link'>
				<a href={doc} download className={scss.link}>Учебный материал для участия в конкурсе: "Лучшая методическая разработка учебного занятия." <br/> </a>	
			</div>
